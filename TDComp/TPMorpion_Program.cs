    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (continu == 'O')
            {
                ...
                while (!gagne)
                {
                    ...
                    {
                        Console.WriteLine("Rentrez la ligne puis la colonne de votre prochain pion!");
        ...
        static int[] PlacementJoueur(int abscisse, int ordonnee)
        {
            ...
            if ((abscisse < 0 || abscisse > 2) && (ordonnee < 0 || ordonnee > 2))
            {
                ...
                abscisse = Convert.ToChar(Console.ReadLine());
                ordonnee = Convert.ToChar(Console.ReadLine());
